      ...
      <div className="mx-auto max-w-5xl">
        ...
        <div className="mt-8 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <StatCard
            ...
            value={
              subscription
                ? subscription.messagesLimitPerPeriod
                  ? `${subscription.messagesUsed}/${subscription.messagesLimitPerPeriod}`
                  : String(subscription.messagesUsed)
                : "—"
            }
            accent="amber"
            icon={
          ...
          >
            {subscription?.messagePeriodResetAt && (
              <p className="mt-1 text-xs text-slate-500">
                Se renueva el{" "}
                {new Date(subscription.messagePeriodResetAt).toLocaleDateString("es-MX", {
                  day: "2-digit",
                  month: "2-digit",
                })}
              </p>
